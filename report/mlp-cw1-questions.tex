...
\youranswer{the training and validation curves of classification both show an improvement over time in the first 10 epocs, but soon after the validation curve starts to decrease while the training curve continues to increase steadily. This is a clear sign of overfitting, as the model is learning the training data too well and is not generalising well to the validation data. The cross-entropy error curves (Figure 1b) shows a similar trend, but in the opposite way: in the first epocs both errors tend to reduce significantly and after the same 10 epocs the validation curve begins to increase learly while the training curve still decreasing, again a sign of overfitting. It is interesting to note that in both a and b the training plot shows better performance torwards an asymptote, but the gap between the training and validation curves grows much faster in the error curves than in the accuracy curves.}
}
...
\begin{figure}[t]
    ...
    \begin{subfigure}{\linewidth}
        \includegraphics[width=\linewidth]{figures/fig_1layer/32accuracy.png}
        \caption{accuracy by epoch}
        \label{fig:width_acccurves}
    \end{subfigure} 
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/fig_1layer/32error.png}
...
\begin{table}[t]
    ...
    \midrule
         32            &    7.87e-01   &  5.51e-01 &   6.89e-01            \\
         64            &    8.09e-01   &  3.41e-01  &   6.74e-01               \\
         128           &    8.03e-01   &  1.69e-01  &   9.94e-01           \\ 
    \bottomrule
    \end{tabular}
...
\begin{table}[t]
    ...
    \midrule
         1               &      8.03e-01      &   1.69e-01 & 9.94e-01          \\
         2               &      8.18e-01      &   9.21e-02 & 1.52                \\
         3               &      8.22e-01      &   1.12e-01 & 1.78                \\ 
    \bottomrule
    \end{tabular}
