...
class MNISTDataProvider(DataProvider):
    ...
    def to_one_of_k(self, int_targets):
        ...
        Args:
            int_targests (ndarray): Array of integer coded class targets (i.e.
        ...
        """
        one_of_k_targets = np.zeros((int_targets.size, self.num_classes))
        one_of_k_targets[np.arange(int_targets.size), int_targets] = 1
